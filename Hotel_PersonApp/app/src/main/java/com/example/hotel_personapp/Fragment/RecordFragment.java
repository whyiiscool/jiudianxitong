...
public class RecordFragment extends Fragment {
    ...
    protected void initrecordview(View view){
        tabLayout = view.findViewById(R.id.tab_record);
        viewpager = view.findViewById(R.id.vp_record);
        ...
        TitleFragmentPagerAdapter adapter = new TitleFragmentPagerAdapter(getFragmentManager(), fragments, new String[]{"全部", "未入住", "已入住","待评价","已取消"});
